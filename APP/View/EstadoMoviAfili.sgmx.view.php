...
<div class="x_panel">
<div class="x_title">
<h2> <?php echo utf8_encode( 'Estado de movimientos Afiliatorios');?></h2><!--mostrar acentos php-->
...
<div class="col-lg-3">
<div class="input-group">
<span class="input-group-addon">Nòmina</span>
...
<script type="text/javascript" src="/Script/js/funcion.Jquery.EstadoMoviAfili.js"></script>
