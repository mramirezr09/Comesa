...
<!-- <script src="<?php echo SRVURL; ?>Script/js/funcion.Jquery.close.js"></script> -->
	<div class="">
		<div class="page-title">
			...
			<script type="text/javascript" src="/Script/js/funcion.Jquery.ReporteBaseExcel.js"></script>
				<div class="">
					<br>
					<p> <strong> IMPORTANTE: </strong>Para poder generar este reporte, es necesario filtrar (Buscar) el rango de las fechas de contratación deseadas. <p>
