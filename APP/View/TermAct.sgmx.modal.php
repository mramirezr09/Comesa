...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg-upd"><i class="fa fa-download"></i> Generar Lista de Actividades</button>
...
<input type="hidden" value="4" name="documento">
