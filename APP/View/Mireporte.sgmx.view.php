...
?>
  <div class="">
    ...
    <p>
      <strong>Nota: </strong>
      Para poder generar estos documentos, es necesario filtrar (Buscar) el rango de fechas del corte correspondiente.
    </p>
...
<script type="text/javascript" src="/Script/js/funcion.Jquery.Mireporte.js"></script>
