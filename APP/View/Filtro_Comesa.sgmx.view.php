	...
	<div class="page-title">
		<div class="clearfix"></div>
			<div class="col-md-12 col-sm-12 col-xs-12">
				<br>
				<?php
					include("nuevo_registro.sgmx.modal.php");
					include("actualiza_filtro.sgmx.modal.php");
				?>

				<br>
				<div class="x_panel">
					<div class="x_title">
						<h2>Filtro Juridico</h2>
					...
					<form class="form-horizontal" role="form" id="ticket">
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Consulte por Nombre, Curp, Fase o Puesto" onkeyup='load(1);'>
							</div>
							<div class="col-md-3">
